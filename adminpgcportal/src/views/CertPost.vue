<template>
  <h1 class="card-header pb-3">Issued Post-Inspection Certificate</h1>
        ...
        <table class="table">
          <thead>
            <tr>
              ...
              <th scope="col" style="vertical-align: middle;">Reference No.</th>
              <th scope="col" style="vertical-align: middle;">Certificate No.</th>
              <th scope="col" style="vertical-align: middle;">Name of User</th>
              <th scope="col" style="vertical-align: middle;">Department</th>
              <th scope="col" style="vertical-align: middle;">Division</th>
              <th scope="col" style="vertical-align: middle;">Type of Device</th>
              <th scope="col" style="vertical-align: middle;">Brand and Model</th>
              <th scope="col" style="vertical-align: middle;">Issued Date</th>
              <th scope="col" style="vertical-align: middle;">Recommendation</th>
              <th scope="col" style="vertical-align: middle;">Assigned Tech</th>
            </tr>
          </thead>
          <tbody>
  ...
  <v-dialog v-model="dialog" persistent width="700">
    <v-card>
      <v-card-title class="custom-title"> Add for Post-Inspection </v-card-title>
...
export default {
  ...
  mounted() {
    ...
    this.channel = echo.channel("portal-notifications").listen("PortalNotification", (e) => {
      if (e.message === "triggerPostInspection") {
        this.fetch();
      }
    });
  },
  ...
  methods: {
    ...
    async exportToPDF(item) {
      ...
      const docDefinition = {
        pageSize: "A4",
        pageMargins: [20, 0, 20, 0], // left=40, top=0, right=40, bottom=60
        defaultStyle: {
          font: "TimesNewRoman",
        },
        content: [
                ...
                stack: [
                  ...
                  },
                  {
                    text: [
                      ...
                      { text: "POST-INSPECTION", bold: true },
                      " on the ",
                      ...(item.Device === "Others"
                        ? []
                        : [
                      ...
                      " was conducted. Below is the detail of the post-inspection:",
                    ],
                    alignment: "justify",
                    margin: [0, 0, 0, 20],
                  },
    ...
    addPre() {
      ...
      axios({
        method: "post",
        url: process.env.VUE_APP_API + "PGCCertPost/addPRE",
        headers: {
    ...
    fetchUsers() {
      ...
      axios({
        method: "get",
        url: process.env.VUE_APP_API + "PGCCertPost/fetchRequest",
        headers: {
          Authorization: "Bearer " + localStorage.getItem("xxx"),
        },
      })
    ...
    fetch(paramType = null) {
      ...
      let loadData = () => {
        ...
        axios({
          method: "get",
          url: process.env.VUE_APP_API + "PGCCertPost/fetchPost",
          headers: {
            Authorization: "Bearer " + localStorage.getItem("xxx"),
          },
          params: myParameter,
    ...
    DeleteReq() {
      ...
      axios({
        method: "post",
        url: process.env.VUE_APP_API + "PGCCertPost/DeleteReq",
        headers: {
          Authorization: "Bearer " + localStorage.getItem("xxx"),
        },
        data: {
